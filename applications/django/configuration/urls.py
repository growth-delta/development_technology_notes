...
urlpatterns = [
    ...
    path('ai/', include('applications.ai.urls')), # AI
        # JavaScript Applications
    path('react.js/', include('applications.react.urls')), # React.js Frontend Applications
        # Python Applications
    path('python/', include('applications.py.urls')), # React.js Frontend Applications
]
